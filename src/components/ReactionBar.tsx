...
export function ReactionBar({ targetType, targetId, playerId, commentCount, onCommentClick, compact }: Props) {
  ...
  const btn = "relative z-10 flex items-center gap-1 rounded-full border border-border bg-white px-2.5 py-1 text-xs font-semibold text-ink-soft active:opacity-80";
